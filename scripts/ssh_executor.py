...
class SshExecutor:
    ...
    def execute_command(self,command:str,check=True):
        ...
        try:
            ...
            raise Exception(f"Failed to execute command {command} on {self.ip}: {str(e)}")
    ...
    def upload_file(self, local_path, remote_path=None):
        ...
        try:
            ...
            raise Exception(f"Failed to upload file {local_path} to {remote_path} on {self.ip}: {str(e)}")
    ...
    def execute_script(self,script_path,check=True,remote_path=None):
        ...
        try:
            ...
            raise Exception(f"Failed to execute script {script_path} on {self.ip}: {str(e)}")
    ...
    def download_file(self,remote_path,local_path=None):
        ...
        try:
            ...
            raise Exception(f"Failed to download file {remote_path} to {local_path} on {self.ip}: {str(e)}")
